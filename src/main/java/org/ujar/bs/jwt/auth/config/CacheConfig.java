package org.ujar.bs.jwt.auth.config;
...
class CacheConfig {
  ...
  JCacheManagerCustomizer cacheManagerCustomizer() {
    return cm -> {
      createCache(cm, org.ujar.bs.jwt.auth.entity.Role.class.getName());
      createCache(cm, org.ujar.bs.jwt.auth.entity.User.class.getName());
    };
  }
